...
SUB = {
 ...
 "A2_victory":   ("A 시스템", "승리 팡파레", r"\b(victory|fanfare|fanfar|triumph(ant)?|you win|winner|win(ning)? theme|\bwin\b|victor(y|ious)?|clear!?|stage clear|level clear|quest complete|mission complete|success|congratulations|well done|battle won|we did it|celebration sting)\b|勝利|ファンファーレ|クリア|成功|達成", 1),
 ...
 "C5_resolve":   ("C 전투", "결전 직전/결의", r"\b(determination|determined|resolve|resolution|conviction|before the (battle|storm|fight|war|dawn)|calm before|prepar(e|ing|ation)|call to arms|rally(ing)?|march to war|eve of|last night|vow|oath|pledge|stand (up|strong|together|firm|your ground|alone)|rise up|courage|bravery|steel(ing)? (yourself|resolve)|no turning back|point of no return|gathering (storm|forces)|the plan|strategy|council of war|final preparations|ready for)\b|決意|覚悟|決戦前|出陣|前夜|誓い|勇気|奮起|覚醒", 3),
