...
모아, **길드 홀 겸 마을 여관**으로 꾸민 재생기에서 틀어주는 프로젝트입니다. 기본 용도는 **일하며 틀어놓기**.
...
- **여관 홀** — 나무와 돌로 짠 가구, 인두로 지진 나무 팻말, 놋쇠 못과 밧줄. 가구는 CSS 그라디언트로, 벽과 화로의 돌결은 그림 한 장을 soft-light 로 얹어 냅니다. 색은 CSS 가 내므로 장소를 갈아입어도 따라옵니다.
...
- **화로와 악보대** — 노래가 시작되면 불이 붙고, 곡이 바뀌면 악보대의 양피지가 넘어갑니다. 양피지에는 원곡으로 나가는 자리가 붙어 있어, 마음에 든 곡을 만든 사람에게 곧장 갈 수 있습니다.
- **화로에 걸린 음식** — 고기 꼬치, 돼지 통구이, 마법의 냄비, 마시멜로, 감자와 옥수수, 민물고기, 혹은 아무것도. 꼬치걸이대에 걸리고(감자와 옥수수만 잉걸 위에 놓입니다) 네 단계로 익다가 안 먹으면 탑니다. **덜 익은 것은 눌러도 안 먹힙니다** — 손만 뻗었다 말고 "아직 이릅니다" 소리가 납니다. 다 익은 것은 씹는 소리가, 태워 먹은 것은 푸석하게 바스러지는 소리가 납니다.
- **합성 소리** — 문간 종, 장작 튀는 소리, 잔 부딪는 소리, 류트 퉁기는 소리, 씹는 소리, 마른 것 바스러지는 소리를 그 자리에서 만듭니다. 음원 파일이 없으니 라이선스도 CSP 구멍도 필요 없습니다.
...
바드 문답의 "노래는 어느 만큼 들리면 되겠습니까" 답변이 이 하한을 정합니다.
